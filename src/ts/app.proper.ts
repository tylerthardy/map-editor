...
export class ProperApp {
  ...
  private _bindComponentEventListener = (container: ComponentContainer, itemConfig: ResolvedComponentItemConfig) =>
  ...
  constructor(
    @inject('Factory<BrushComponent>')
    private _brushComponentFactory: (
  ...
  private createComponent(
    ...
    switch (componentTypeName) {
      case BrushComponent.typeName:
        return this._brushComponentFactory(container, state, virtual);
      default:
  ...
  private handleBindComponentEvent(
    ...
    if (this._useVirtualEventBinding) {
      ...
      container.virtualVisibilityChangeRequiredEvent = (container, visible) =>
        this.handleContainerVirtualVisibilityChangeRequiredEvent(container, visible);
